    ...
    const plantsArray = [
        ...
        },
        {
            ...
            plants: [
                ...
                { name: "Hyacinth", image: "https://cdn.pixabay.com/photo/2019/04/07/20/20/hyacinth-4110726_1280.jpg", description: "A beautiful flowering plant known for its fragrant blooms.", cost: "$22" }
            ]
        },
        {
